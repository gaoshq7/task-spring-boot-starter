...
/**
 * Project : galaxy
 * Class : cn.gsq.task.context.AbstractIfTransform
 *
 * @author : gsq
 * @date : 2023-12-06 10:19
 * @note : It's not technology, it's art !
 **/
@Slf4j
public abstract class AbstractIfTransform extends NodeIfComponent {
    ...
    **/
     ...
     * @note : ⚠️ 有异常向上抛出 !
    **/
    protected abstract boolean operateIf() throws Exception;
