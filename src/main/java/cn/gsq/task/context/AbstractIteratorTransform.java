...
/**
 * Project : galaxy
 * Class : cn.gsq.task.context.AbstractIteratorTransform
 *
 * @author : gsq
 * @date : 2023-12-06 10:10
 * @note : It's not technology, it's art !
 **/
@Slf4j
public abstract class AbstractIteratorTransform extends NodeIteratorComponent {
    ...
    **/
    ...
    public Iterator<?> processIterator() throws Exception {
        Iterator<?> iterator = operateIterator();
        this.info("执行成功");
        return iterator;
    }
     ...
     * @note : ⚠️ 有异常向上抛出 !
    **/
    protected abstract Iterator<?> operateIterator() throws Exception;
