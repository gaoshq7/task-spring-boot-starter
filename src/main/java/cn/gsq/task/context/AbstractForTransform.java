...
/**
 * Project : galaxy
 * Class : cn.gsq.task.context.AbstractForTransform
 *
 * @author : gsq
 * @date : 2023-12-05 17:57
 * @note : It's not technology, it's art !
 **/
@Slf4j
public abstract class AbstractForTransform extends NodeForComponent {
    ...
    **/
     ...
     * @note : ⚠️ 有异常向上抛出 !
    **/
    protected abstract int operateFor() throws Exception;
