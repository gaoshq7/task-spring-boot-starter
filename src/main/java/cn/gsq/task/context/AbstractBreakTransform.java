...
/**
 * Project : galaxy
 * Class : cn.gsq.task.context.AbstractBreakTransform
 *
 * @author : gsq
 * @date : 2023-12-06 10:18
 * @note : It's not technology, it's art !
 **/
@Slf4j
public abstract class AbstractBreakTransform extends NodeBreakComponent {
    ...
    **/
     ...
     * @note : ⚠️ 有异常要向上抛出 !
    **/
    protected abstract boolean operateBreak() throws Exception;
